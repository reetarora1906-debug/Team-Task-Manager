  ...
  return (
    <div className="h-screen w-full overflow-hidden flex items-center selection:bg-primary selection:text-white font-inter" 
        ...
        <div className="animate-in fade-in slide-in-from-left-4 duration-700">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
                <div className="w-5 h-5 rounded-full bg-emerald-500/20 flex-shrink-0 flex items-center justify-center text-[10px] text-emerald-400">✓</div>
                <div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-16 overflow-y-auto">
        <div className="w-full max-w-md glass-panel p-10 rounded-2xl animate-in fade-in slide-in-from-right-4 duration-700">
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-3 border rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary  backdrop-blur-md bg-white/10 border-white/20"
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-12 py-3 border rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary  backdrop-blur-md bg-white/10 border-white/20"
                  placeholder="••••••••"
                  required
                />
                <button
